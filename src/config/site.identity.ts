export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'tarasview',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Tarasview',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'tarasview.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://tarasview.com',
